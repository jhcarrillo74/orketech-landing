...
const ComoFunciona = () => {
  ...
  return (
    <section id="como-funciona" className="py-16 lg:py-24 bg-[#1E2140]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Título */}
        <h2 className="font-space-grotesk font-bold text-white text-3xl lg:text-4xl mb-12 lg:mb-16 text-center">
          Cómo funciona
        </h2>
